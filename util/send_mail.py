...
class SendEmail:
    ...
    global email_host
    global password
    password = "zhang870328"
    email_host = "smtp.163.com"
    send_user = "13601625014@163.com"
    ...
    def send_mail(self, user_list, sub, content):
        ...
        #server.connect(email_host, 25)  # 启用SSL发信, 端口一般是465
    ...
    def send_main(self, pass_list, fail_list, no_run_list):
        ...
        print("1send pass_list data:", pass_num)
        print("2send fail_list data:", fail_num)
        # 未执行的用例
        no_run_num = len(no_run_list)
        print("3send no_run_num data:", no_run_num)
        count_num = pass_num + fail_num + no_run_num
        print("4send count_num data:", count_num)
       ...
       '''
        ...
        user_list = ['zhangxue@kedacom.com', 'huyimin@kedacom.com']
        sub = "接口自动化测试报告"
